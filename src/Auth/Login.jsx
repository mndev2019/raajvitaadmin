                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full h-14 px-5 pr-12 rounded-2xl border border-[#ecd9b0] bg-[#faf7f2] focus:outline-none focus:border-[#c89b3c] text-[#3c0d12] placeholder:text-[#8d7b72]"
                                required
                            />
                            ...
                            <button
                                ...
                                className="absolute right-4 top-1/2 -translate-y-1/2 text-[#8d7b72] hover:text-[#3c0d12]"
                            >
